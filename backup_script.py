...
Hopefully this will help in case of save file corruption, happened to me after 10 hours of gameplay.
If you click Continue and get an infinite loading screen, bad savefile is probably the reason. 
Tons of payers have reported similar issues, some losing 10s of hours of play, but your milage may vary.
Dont save scum, let the dice fall where they do.
"""

"""
Features:
 - checks save file location based on your OS [@todo still need to fix these]
